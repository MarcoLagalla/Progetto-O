...
public final class INIFile
{
    ...
    /**
     * Create a iniFile object for the specified file using the supplied input stream.
     * @param pstrPathAndName The full path and name of the INI file
     * @param is The input stream of the INI file using which to read the contents
     */
...
----------------------------------------------------------------------------------------------------------------------------------*/
    ...
    public String getStringProperty(String pstrSection, String pstrProp)
    {
        ...
        objSec = (INISection) _hmapSections.get(strKey);
        if (objSec != null)
        {
...
----------------------------------------------------------------------------------------------------------------------------------*/
    ...
    public String[] getAllSectionNames()
    {
    	...
    	if (_hmapSections.isEmpty()) return new String[0];
    ...
    public boolean save()
    {
        ...
        try
        {
            if (_hmapSections.isEmpty()) return false;
 ...
 *--------------------------------------------------------------------------------------------------------------------------------*/
    ...
    public class INISection
    {
        ...
        public String[] getPropNames()
        {
        	...
        	if (_hmapProps.isEmpty()) return new String[0];
        ...
        public INIProperty getProperty(String pstrProp)
        {
            ...
            strKey = pstrProp.toUpperCase();
            if (_hmapProps.containsKey(strKey))
                objRet = (INIProperty) _hmapProps.get(strKey);
        ...
        public String toString()
        {
            ...
            try
            {
	            ...
	            if (_strComment != null)
	            {
	            	if (!_strComment.startsWith(";"))
	            		objBuf.append(";");
	                objBuf.append(_strComment)
	                	.append("\r\n");
	            }
	            ...
	            for (Map.Entry<String, INIProperty> entry : _hmapProps.entrySet())
	            	objBuf.append(entry.getValue().toString())
	            		.append("\r\n");
